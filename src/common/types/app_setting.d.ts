...
declare global {
  ...
  declare namespace LX {
    ...
    interface AppSetting {
       ...
       * 专注中左栏（计时区）的宽度，单位 px。
       *
       * 拖动两栏之间的分隔条即可调整，双击分隔条复位。计时环直径由它派生
       * （环径 = 栏宽 − 68，其中 68 是卡片左右内边距 48 加 20 的缓冲），
       * 因此调宽这一栏时圆环会跟着放大，反过来则把空间让给右侧的播放面板。
       */
      'focus.timerPaneWidth': number

      /**
       * 专注中的播放面板是否显示歌词。
       *
       * 关闭后歌词区隐藏，封面与歌曲信息居中放大。仅影响专注页的展示，
       * 与桌面歌词、歌词滚动等播放器自身能力无关。
       */
      'focus.showLyric': boolean
    }
  }
